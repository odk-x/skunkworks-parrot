...
The client can send notifications to all or a group of workers. This group can either be an ODK Group or a custom group created in this application. users are required to scan the QR code using skunkworks-bat, generated while creating the group to be a part of it. Whereas members of ODK Groups are added by default.
